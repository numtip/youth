...
// Blueprint: every published project/activity needs at least one structured
// source/reference record (an object with title + url). legacyUrls are
// separate redirect paths and do NOT satisfy this requirement.
